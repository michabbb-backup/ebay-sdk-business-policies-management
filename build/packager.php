...
$autoLoader = 'dts-business-policies-management-autoloader.php';
...
$packager->createZip(__DIR__ . '/artifacts/dts-business-policies-management.zip');
$packager->createPhar(__DIR__ . '/artifacts/dts-business-policies-management.phar', null, $autoLoader);
