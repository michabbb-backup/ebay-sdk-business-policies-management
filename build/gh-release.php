...
$owner = 'davidtsadler';
$repo = 'ebay-sdk-business-policies-management';
...
assert(file_exists(__DIR__ . '/artifacts/dts-business-policies-management.zip'));
assert(file_exists(__DIR__ . '/artifacts/dts-business-policies-management.phar'));
...
$client->post(
    $uploadUrl . '/assets?name=dts-business-policies-management.zip',
    array('Content-Type' => 'application/zip'),
    fopen(__DIR__ . '/artifacts/dts-business-policies-management.zip', 'r')
)->send();

$client->post(
    $uploadUrl . '/assets?name=dts-business-policies-management.phar',
    array('Content-Type' => 'application/phar'),
    fopen(__DIR__ . '/artifacts/dts-business-policies-management.phar', 'r')
)->send();
