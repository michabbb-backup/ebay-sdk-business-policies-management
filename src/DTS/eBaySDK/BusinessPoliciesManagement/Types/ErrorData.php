...
/**
 *
 * @property DTS\eBaySDK\BusinessPoliciesManagement\Types\ErrorCategory(string) $category
 ...
 * @property DTS\eBaySDK\BusinessPoliciesManagement\Types\ErrorSeverity(string) $severity
