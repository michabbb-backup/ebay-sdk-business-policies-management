...
tag: check_tag
	@echo Tagging $(TAG)
	chag update $(TAG)
	sed -i -e "s/const VERSION = '.*'/const VERSION = '$(TAG)'/" src/DTS/eBaySDK/BusinessPoliciesManagement/Services/BusinessPoliciesManagementBaseService.php
	php -l src/DTS/eBaySDK/BusinessPoliciesManagement/Services/BusinessPoliciesManagementBaseService.php
